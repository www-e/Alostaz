 ...
 * Provides the layout structure for student routes with proper authorization
 */
...
const StudentLayout: React.FC<StudentLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'الحضور', href: '/student/attendance', icon: CalendarIcon },
    { name: 'المدفوعات', href: '/student/payments', icon: CurrencyDollarIcon },
    { name: 'الواجبات', href: '/student/homework', icon: BookOpenIcon },
    { name: 'الملف الشخصي', href: '/student/profile', icon: UserIcon },
  ];
        ...
        >
          <div className="h-full flex flex-col">
            ...
            <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-800 dark:text-white">منصة الطالب</h2>
              <button
